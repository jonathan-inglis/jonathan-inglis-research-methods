...
* Run regression: 
reg calledback eliteschoolcandidate bigcompanycandidate
...
esttab regression_called_back using assignment1.rtf, $tableoptions keep(eliteschoolcandidate bigcompanycandidate _cons) 